...
public interface AuthMapper {
	 ...
	 * If an expiration date is set and before now, this returns nothing.
	 * @param token secure login key
	 * @return the found user or null, if none was found or the expiration date is in the past
	 */
	 ...
	 * @return role associated with ID
	 */
	...
	/**
	 * Update secure login key to given token and set PIN to null.
	...
	/**
	 * Update the users' secure login key PIN, so
	 * they can only log in using both, key and PIN.
	 * @param userId user id of user to update
	 * @param pin PIN to set for the login key auth
	 */
	void updateUserLoginKeyPin(@Param("userId") int userId,
